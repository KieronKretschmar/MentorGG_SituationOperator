...
namespace SituationDatabase.Migrations
{
    ...
    [Migration("20200525092728_more-situations")]
    partial class moresituations
    {
            ...
            modelBuilder.Entity("SituationDatabase.Models.DeathInducedBombDrop", b =>
                {
                    ...
                    b.Property<int>("ClosestTeammateDistance")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SituationDatabase.Models.KillWithOwnFlashAssist", b =>
                {
                    ...
                    b.Property<int>("TimeBetweenDetonationAndKill")
                        .HasColumnType("int");

                    b.Property<int>("TimeFlashedAfterDeath")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SituationDatabase.Models.TeamFlash", b =>
                {
                    ...
                    b.Property<int>("FimeFlashedTeammates")
                        .HasColumnType("int");
