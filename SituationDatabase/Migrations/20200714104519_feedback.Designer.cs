...
namespace SituationDatabase.Migrations
{
    ...
    [Migration("20200714104519_feedback")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SituationDatabase.Models.BombDropAtSpawn", b =>
                {
                    ...
                    b.ToTable("BombDropAtSpawn");
                });

            modelBuilder.Entity("SituationDatabase.Models.Clutch", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SituationDatabase.Models.CollateralKill", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SituationDatabase.Models.FlashAssist", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("FlashedEnemiesDeaths")
                        .HasColumnType("int");
                    ...
                    b.ToTable("FlashAssist");
                });

            modelBuilder.Entity("SituationDatabase.Models.HasNotBoughtDefuseKit", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("DefuseKitsInTeam")
                        .HasColumnType("int");
                    ...
                    b.ToTable("HasNotBoughtDefuseKit");
                });

            modelBuilder.Entity("SituationDatabase.Models.HighImpactRound", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HighImpactRound");
                });

            modelBuilder.Entity("SituationDatabase.Models.KillThroughSmoke", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SituationDatabase.Models.MissedTradeKill", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("DistanceToVictim")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MissedTradeKill");
                });

            modelBuilder.Entity("SituationDatabase.Models.MultiKill", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<short>("FirstKillWeapon")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("SituationDatabase.Models.SituationInfoByRank", b =>
                {
                    b.Property<int>("PlayerRoundCount")
                        .HasColumnType("int");

                    b.Property<int>("RankBeforeMatch")
                        .HasColumnType("int");

                    b.Property<int>("SituationCount")
                        .HasColumnType("int");

                    b.ToTable("RankDistribution");
                });
            ...
            modelBuilder.Entity("SituationDatabase.Models.TradeKill", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("TimeBetweenKills")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SituationDatabase.Models.HasNotBoughtDefuseKit", b =>
                {
                    b.HasOne("SituationDatabase.Models.MatchEntity", "Match")
                        .WithMany("HasNotBoughtDefuseKit")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
